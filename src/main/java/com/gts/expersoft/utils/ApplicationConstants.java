...
public class ApplicationConstants {
	...
	public static final String NON_TECH = "non-tech";
	public static final String DEVELOER = "developer";
	
	public static final int PROFILE_PAGE_ID = 74;
	public static final int ACCESS_PAGE_ID = 75;
	public static final int PRODUIT_PAGE_ID = 77;
	...
	public static final String PRODUIT_PAGE_NAME = "produit";
